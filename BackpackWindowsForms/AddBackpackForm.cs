...
{
    public partial class AddBackpackForm : Form
    {
        ...
        public AddBackpackForm(List<Material> materials, List<Shape> shapes, List<string> colors, List<FreeBackpack> freeBackpack, string path)
        {
        ...
        private void AddBackpackForm_Load(object sender, EventArgs e)
        {
        ...
        private void Approve_Click(object sender, EventArgs e)
        {
            ...
            _freeBackpack.Add(new FreeBackpack(tag, shape, material, color));
